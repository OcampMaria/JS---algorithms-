      ...
      $.ajax({
        ...
        $(".cityName").html(
          "<div class='cityInfo sections' id='outputWeather'" +
            ...
            cityName +
            currentDate +
            "<img class='image' src= http://openweathermap.org/img/w/" +
        ...
        for (var i = 0; i < array.length; i++) {
          ...
          $(".weather-app").append(
            "<div class= 'forecast'>" +
              ...
              "</h2>" +
              "<img class='image' src= http://openweathermap.org/img/w/" +
              dataOneCall.daily[i].weather[0].icon +
              ".png>" +
              "<h3> Temperature: " +
              dataOneCall.daily[i].temp.day +
              " &deg;F</h3>" +
              "<h3> Humidity: " +
              dataOneCall.daily[i].humidity +
              "%</h3>" +
              "</div>" +
              "</div>"
          );
